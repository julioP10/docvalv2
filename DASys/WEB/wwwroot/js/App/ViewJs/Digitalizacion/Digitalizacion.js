...
var urlVehiculo= "/Mantenimiento/Vehiculo/Listar";
var urlMaquinaria= "/Mantenimiento/Maquinaria/Listar";
var Digitalizacion = function () {
    ...
    var dataTableVehiculoView = function (urlVehiculo) {
        //if (!$.fn.DataTable.isDataTable('#ColaboradorDataTable')) {
        dataTableVehiculo = $("#VehiculoDataTable").dataTable({
            ...
            "columns": [
                ...
                {
                    "data": function (obj) {
                        return '<a href="javascript:void(0)" class="btnDigitalizarVehiculo"  data-digitalizacion="' + obj.digitalizacion + '" data-id="' + obj.idVehiculo+ '">' + obj.nombre + '</a>';
                    }
                },
                { "data": "empresa" },
                { "data": "categoria" },
                ...
                { "data": "marca" },
                {
                    "data": function (obj) {
                        //return "" Agregando los botone
                        return '<div><a href="javascript:void(0)" class="btnDigitalizarVehiculo"" data-digitalizacion="' + obj.digitalizacion + '" data-id="' + obj.idVehiculo + '" data-toggle="tooltip" title="Digitalizar"><i class="fa fa-file-pdf-o"></i></a>';
                    }
                }
            ],
            "aoColumnDefs": [
    ...
    var dataTableMaquinariaView = function (urlMaquinaria) {
        //if (!$.fn.DataTable.isDataTable('#ColaboradorDataTable')) {
        dataTableMaquinaria = $("#MaquinariaDataTable").dataTable({
            ...
            "columns": [
                ...
                {
                    "data": function (obj) {
                        return '<a href="javascript:void(0)" class="btnDigitalizarMaquinaria"  data-digitalizacion="' + obj.digitalizacion + '" data-id="' + obj.idMaquinaria + '">' + obj.nombre + '</a>';
                    }
                },
                { "data": "empresa" },
                { "data": "categoria" },
                ...
                { "data": "marca" },
                {
                    "data": function (obj) {
                        //return "" Agregando los botone
                        return '<div><a href="javascript:void(0)" class="btnDigitalizarMaquinaria"" data-digitalizacion="' + obj.digitalizacion + '" data-id="' + obj.idMaquinaria + '" data-toggle="tooltip" title="Digitalizar"><i class="fa fa-file-pdf-o"></i></a>';
                    }
                }
            ],
            "aoColumnDefs": [
    ...
    var Eventos = function (Digitalizacion_CTL) {
        ...
        //ir a vehiculo
        $(Digitalizacion_CTL).on("click", "a.btnDigitalizarVehiculo", function () {

            var _digitalizacion = $(this).attr("data-digitalizacion");
            var _vehiculoid = $(this).attr("data-id");
            window._digitalizacionOpcion = _digitalizacion;
            window._Vehiculo = _vehiculoid;
            webApp.getDataVistaViewPartial(urlDigitalizacionVehiculo, function () {
                $("#espacio #_EstadoDigitalizacion").val(_digitalizacion);
            });
        });

        //ir a maquinaria
        $(Digitalizacion_CTL).on("click", "a.btnDigitalizarMaquinaria", function () {

            var _digitalizacion = $(this).attr("data-digitalizacion");
            var _maquinariaid = $(this).attr("data-id");
            window._digitalizacionOpcion = _digitalizacion;
            window._Maquinaria = _maquinariaid;
            webApp.getDataVistaViewPartial(urlDigitalizacionMaquinaria, function () {
                $("#espacio #_EstadoDigitalizacion").val(_digitalizacion);
            });
        });
    }
    return {
        init: function () {
            ...
            if (entidad === "Vehiculo") {
                dataTableVehiculoView(urlVehiculo);
            }
            if (entidad === "Maquinaria") {
                dataTableMaquinariaView(urlMaquinaria);
            }
