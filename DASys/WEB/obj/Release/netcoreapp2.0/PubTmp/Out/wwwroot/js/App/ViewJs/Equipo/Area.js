            ...
            dataTableArea = $("#AreaDataTable").dataTable({
                ...
                "columns": [
                    ...
                    { "data": "estado" },
                    {
                        "data": function (obj) {
                            var _htmlOpcion = "";
                            _htmlOpcion += '<div><a href="javascript:void(0)" class="btnConsultarArea" data-id="' + obj.idArea + '" data-toggle="tooltip" title="Consultar"><i class="fa fa-search"></i></a>';
                        
                            if (__Perfil === "SUPERUSUARIO") {
                          
                                _htmlOpcion += '<a href="javascript:void(0)" class="btnEditarArea"  data-id="' + obj.idArea + '" data-toggle="tooltip" title="Editar"><i class="fa fa-edit"></i></a>';
                                _htmlOpcion += '<a href="javascript:void(0)" class="btnEliminar"  data-id="' + obj.idArea + '" data-toggle="tooltip" title="Eliminar"><i class="fa fa-trash"></i></a>';
                            } else {
                                $("#btnAreaRegistro").remove();
                            }
                            _htmlOpcion += "</div>";
                            return _htmlOpcion;
