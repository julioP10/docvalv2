...
var contacto = null;
var dataTableDigitalizacionMaquinaria = null;
var selectedRow = 0;
var mensajeRegistro = '¿Desea registrar los datos ingresados?';
var mensajeActualizar = '¿Desea actualizar los datos ingresados?';
var tituloActualizar = 'Actualizar DigitalizacionMaquinaria';
var tituloRegistro = 'Registrar  DigitalizacionMaquinaria';
var typeActualizar = 'Actualizar';
var typeRegistro = 'Registrar';

var DigitalizacionMaquinaria = function () {

    var dataTableDigitalizacionMaquinariaView = function (url) {
        //if (!$.fn.DataTable.isDataTable('#DigitalizacionMaquinariaDataTable')) {
            dataTableDigitalizacionMaquinaria = $("#DigitalizacionMaquinariaDataTable").dataTable({
                "bFilter": false,
                "bProcessing": true,
                "serverSide": true,
                //"scrollY": "400px",
                ...
                "ajax": {
                    ...
                    "data": function (request) {
                        ...
                        request.filter = {
                            ...
                            IdMaquinariaSearch: _Maquinaria
                        }
                    },
    ...
    var Eventos = function (DigitalizacionMaquinaria_CTL) {
        //DigitalizacionMaquinaria
        $(DigitalizacionMaquinaria_CTL).on("click", "a.btnDigitalizacionMaquinaria", function () {
            ...
            var Maquinaria = $(this).attr("data-id");
            ...
            webApp.getDataVistaParam(urlDropZone, param, function (status) {
                ...
                $("#espacio #IdPersona").val(Maquinaria);
                ...
                myDropzone = new Dropzone("#my-awesome-dropzone", {
                    ...
                    init: function () {
                        ...
                        this.on("success", function () {
                            ...
                            dataTableDigitalizacionMaquinaria.fnReloadAjax();
                            $("#myModal").modal("hide");
        ...
        $("#espacio").on("click", "button#btn-enviar-archivo", function () {
            ...
            if (webApp.validateForm(form)) {
                ...
                webApp.sweetajax(mensaje, { url: urlRegistrarDigitalizacionMaquinaria, parametros: query }
        ...
        $(DigitalizacionMaquinaria_CTL).on('click', 'a.btn-ver-documentos', function () {
        ...
        $("#espacio").on("click", "a#btn-cambiar-estado", function () {
            ...
            var persona = "";
            var digitalizacion = "";
            $('#DigitalizacionMaquinariaDataTable tr a').each(function (i, e) {
            ...
            if (cTmp > 0) {
                ...
                webApp.sweetajax(mensaje, { url: urlRegistrarDigitalizacionMaquinaria, parametros: query }
                    , function (jsonResponse) {
                        ...
                        var urlDigitalizacionMaquinariaIndex = _urlIndex;
                        if (jsonResponse.type === "success") {
                            webApp.sweetresponseOk(mensaje.title, jsonResponse, urlDigitalizacionMaquinariaIndex);
                        } else {
    ...
    return {
        init: function () {
            var _this = this;
            _this.DigitalizacionMaquinaria_CTL = $("#DigitalizacionMaquinaria");
            Eventos(_this.DigitalizacionMaquinaria_CTL);
            //Configuracion DataTable
            Utils.ConfigurarDataTable();
            checkSessionUser.checkSession(function () {
                dataTableDigitalizacionMaquinariaView(urlDigitalizacionListarMaquinaria);
            });
