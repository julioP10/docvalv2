...
var contacto = null;
var dataTableDigitalizacionVehiculo = null;
var selectedRow = 0;
var mensajeRegistro = '¿Desea registrar los datos ingresados?';
var mensajeActualizar = '¿Desea actualizar los datos ingresados?';
var tituloActualizar = 'Actualizar DigitalizacionVehiculo';
var tituloRegistro = 'Registrar  DigitalizacionVehiculo';
var typeActualizar = 'Actualizar';
var typeRegistro = 'Registrar';

var DigitalizacionVehiculo = function () {

    var dataTableDigitalizacionVehiculoView = function (url) {
        //if (!$.fn.DataTable.isDataTable('#DigitalizacionVehiculoDataTable')) {
            dataTableDigitalizacionVehiculo = $("#DigitalizacionVehiculoDataTable").dataTable({
                "bFilter": false,
                "bProcessing": true,
                "serverSide": true,
                //"scrollY": "400px",
    ...
    var Eventos = function (DigitalizacionVehiculo_CTL) {
        //DigitalizacionVehiculo
        $(DigitalizacionVehiculo_CTL).on("click", "a.btnDigitalizacionVehiculo", function () {
            ...
            var Vehiculo = $(this).attr("data-id");
            ...
            webApp.getDataVistaParam(urlDropZone, param, function (status) {
                ...
                $("#espacio #IdPersona").val(Vehiculo);
                ...
                myDropzone = new Dropzone("#my-awesome-dropzone", {
                    ...
                    init: function () {
                        ...
                        this.on("success", function () {
                            ...
                            dataTableDigitalizacionVehiculo.fnReloadAjax();
                            $("#myModal").modal("hide");
        ...
        $("#espacio").on("click", "button#btn-enviar-archivo", function () {
            ...
            if (webApp.validateForm(form)) {
                ...
                webApp.sweetajax(mensaje, { url: urlRegistrarDigitalizacionVehiculo, parametros: query }
        ...
        $(DigitalizacionVehiculo_CTL).on('click', 'a.btn-ver-documentos', function () {
        ...
        $("#espacio").on("click", "a#btn-cambiar-estado", function () {
            ...
            var persona = "";
            var digitalizacion = "";
            $('#DigitalizacionVehiculoDataTable tr a').each(function (i, e) {
            ...
            if (cTmp > 0) {
                ...
                webApp.sweetajax(mensaje, { url: urlRegistrarDigitalizacionVehiculo, parametros: query }
                    , function (jsonResponse) {
                        ...
                        var urlDigitalizacionVehiculoIndex = _urlIndex;
                        if (jsonResponse.type === "success") {
                            webApp.sweetresponseOk(mensaje.title, jsonResponse, urlDigitalizacionVehiculoIndex);
                        } else {
    ...
    return {
        init: function () {
            var _this = this;
            _this.DigitalizacionVehiculo_CTL = $("#DigitalizacionVehiculo");
            Eventos(_this.DigitalizacionVehiculo_CTL);
            //Configuracion DataTable
            Utils.ConfigurarDataTable();
            checkSessionUser.checkSession(function () {
                dataTableDigitalizacionVehiculoView(urlDigitalizacionListarVehiculo);
            });
