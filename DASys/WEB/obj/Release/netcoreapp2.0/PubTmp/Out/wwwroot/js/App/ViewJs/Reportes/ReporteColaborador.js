...
var ReporteColaborador = function () {
    ...
    var dataTableReporteColaboradorView = function (url) {

        //if (!$.fn.DataTable.isDataTable('#ReporteColaboradorDataTable')) {
        dataTableReporteColaborador = $("#ReporteColaboradorDataTable").dataTable({
            "bFilter": false,
            "bProcessing": true,
            "serverSide": true,
            //"scrollY": "400px",
    ...
    var Eventos = function (ReporteColaborador_CTL) {

        $(ReporteColaborador_CTL).on("change", "select#TipoEmpresaSearch", function () {
        ...
        $(ReporteColaborador_CTL).on("change", "select#IdEmpresaSearch", function () {
            dataTableReporteColaborador.fnReloadAjax();
        });
        $(ReporteColaborador_CTL).on("change", "select#IdTipoLugarSearch", function () {
            dataTableReporteColaborador.fnReloadAjax();
        });
        $(ReporteColaborador_CTL).on("change", "select#IdDepartamentoSearch", function () {
            var id = $(this).val();
            webApp.ListaUbicacion(id);
            dataTableReporteColaborador.fnReloadAjax();
        });
        $(ReporteColaborador_CTL).on("change", "select#IdUbicacionSearch", function () {
            dataTableReporteColaborador.fnReloadAjax();
        });
    ...
    return {
        init: function () {
            var _this = this;
            _this.ReporteColaborador_CTL = $("#ReporteColaborador");
            Eventos(_this.ReporteColaborador_CTL);
            //Configuracion DataTable
            Utils.ConfigurarDataTable();
            checkSessionUser.checkSession(function () {
                dataTableReporteColaboradorView(urlReporteColaboradorListar);
            });
