                ...
                "columns": [
                    ...
                    { "data": "estado" },
                    {
                        "data": function (obj) {
                            ...
                            return '<div><a href="javascript:void(0)" class="btnConsultarTerminal" data-id="' + obj.idTerminal + '" data-toggle="tooltip" title="Consultar"><i class="fa fa-search"></i></a>\
                                <a href="javascript:void(0)" class="btnEditarTerminal"  data-id="' + obj.idTerminal + '" data-toggle="tooltip" title="Editar"><i class="fa fa-edit"></i></a>\
                            <a href="javascript:void(0)" class="btnEliminar"  data-id="' + obj.idTerminal + '" data-toggle="tooltip" title="Eliminar"><i class="fa fa-trash"></i></a></div>';
