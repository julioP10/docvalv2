                ...
                "columns": [
                    ...
                    { "data": "estado" },
                    {
                        "data": function (obj) {
                            ...
                            return '<div><a href="javascript:void(0)" class="btnConsultarModelo" data-id="' + obj.idModelo + '" data-toggle="tooltip" title="Consultar"><i class="fa fa-search"></i></a>\
                                <a href="javascript:void(0)" class="btnEditarModelo"  data-id="' + obj.idModelo + '" data-toggle="tooltip" title="Editar"><i class="fa fa-edit"></i></a>\
                            <a href="javascript:void(0)" class="btnEliminar"  data-id="' + obj.idModelo + '" data-toggle="tooltip" title="Eliminar"><i class="fa fa-trash"></i></a></div>';
