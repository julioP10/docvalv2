...
var contacto = null;
var dataTableDigitalizacionEmpresa = null;
var selectedRow = 0;
var mensajeRegistro = '¿Desea registrar los datos ingresados?';
var mensajeActualizar = '¿Desea actualizar los datos ingresados?';
var tituloActualizar = 'Actualizar DigitalizacionEmpresa';
var tituloRegistro = 'Registrar  DigitalizacionEmpresa';
var typeActualizar = 'Actualizar';
var typeRegistro = 'Registrar';

var DigitalizacionEmpresa = function () {

    var dataTableDigitalizacionEmpresaView = function (url) {
        //if (!$.fn.DataTable.isDataTable('#DigitalizacionEmpresaDataTable')) {
        dataTableDigitalizacionEmpresa = $("#DigitalizacionEmpresaDataTable").dataTable({
                "bFilter": false,
                "bProcessing": true,
                "serverSide": true,
                //"scrollY": "400px",
    ...
    var Eventos = function (DigitalizacionEmpresa_CTL) {
        //DigitalizacionEmpresa
        $(DigitalizacionEmpresa_CTL).on("click", "a.btnDigitalizacionEmpresa", function () {
                ...
                myDropzone = new Dropzone("#my-awesome-dropzone", {
                    ...
                    init: function () {
                        ...
                        this.on("success", function () {
                            ...
                            dataTableDigitalizacionEmpresa.fnReloadAjax();
                            $("#myModal").modal("hide");
        ...
        $("#espacio").on("click", "button#btn-enviar-archivo", function () {
            ...
            if (webApp.validateForm(form)) {
                ...
                webApp.sweetajax(mensaje, { url: urlRegistrarDigitalizacionEmpresa, parametros: query }
        ...
        $(DigitalizacionEmpresa_CTL).on('click', 'a.btn-ver-documentos', function () {
        ...
        $("#espacio").on("click", "a#btn-cambiar-estado", function () {
            ...
            var persona = "";
            var digitalizacion = "";
            $('#DigitalizacionEmpresaDataTable tr a').each(function (i, e) {
            ...
            if (cTmp > 0) {
                ...
                webApp.sweetajax(mensaje, { url: urlRegistrarDigitalizacionEmpresa, parametros: query }
                    , function (jsonResponse) {
                        ...
                        var urlDigitalizacionEmpresaIndex = _urlIndex;
                        if (jsonResponse.type === "success") {
                            webApp.sweetresponseOk(mensaje.title, jsonResponse, urlDigitalizacionEmpresaIndex);
                        } else {
    ...
    return {
        init: function () {
            var _this = this;
            _this.DigitalizacionEmpresa_CTL = $("#DigitalizacionEmpresa");
            Eventos(_this.DigitalizacionEmpresa_CTL);
            //Configuracion DataTable
            Utils.ConfigurarDataTable();
            
            checkSessionUser.checkSession(function () {
                dataTableDigitalizacionEmpresaView(urlDigitalizacionListarEmpresa);
            });
